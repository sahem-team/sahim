        ...
        <div class="max-w-4xl px-4 mx-auto ">
            <div class="p-6 bg-white rounded-md shadow dark:border-gray-800 dark:bg-gray-900">
                <div class="flex flex-col justify-center items-center mb-6">
                    ...
                    <h2 class=" text-center text-xl font-medium leading-6 text-gray-900 dark:text-gray-300"> إنشاء حساب جهة خيرية
                    </h2>

                </div>
                <form action="/charity-register" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <input name="user_name" type="text" placeholder="مثال:  جمعية التنمية  " value="{{old('user_name')}}"
                                class="rounded-md focus:ring-2 focus:ring-sahem_pr-500 focus:border-sahem_pr-500 ">
                                @error('user_name')
                                <div class="text-red-500">{{$message}}</div>
                                @enderror
